...
Bem-vindo ao Sistema de Gestão de Requisitos de Software! Este projeto é uma ferramenta robusta para auxiliar no ciclo de vida de projetos de software, permitindo o cadastro, visualização, edição, exclusão e acompanhamento de requisitos de forma organizada e eficiente. Desenvolvido com React no frontend, Node.js com Express no backend e PostgreSQL como banco de dados.
...
Este projeto utiliza uma arquitetura full-stack composta por:
